...
policies = {
    # "you": HeuristicPolicy(my_row, my_col, env.num_rows, env.num_cols, belief_filter=None, mode="sample"),
    # "you": HeuristicPolicy(my_row, my_col, env.num_rows, env.num_cols, belief_filter=None, mode="greedy"),
    "you": PolicyWithRollouts(my_row, my_col, env.num_rows, env.num_cols, depth=15, num_rollouts=100),
